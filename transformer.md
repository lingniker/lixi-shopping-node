...
Server_1.default.middleware.registerNamed({
    LoginLog: () => Promise.resolve().then(() => __importStar(global[Symbol.for('ioc.use')]('App/Middleware/LoginLog'))),
    OperLog: () => Promise.resolve().then(() => __importStar(global[Symbol.for('ioc.use')]('App/Middleware/OperLog')))
});
```